...
int main()
{
    ...
    do{
        ...
        cout<<"13.- Salir"<<endl;
        cout<<"\nSeleccione la opcion correspondiente al mes: ";
        cin>>opc;
        ...
        switch(opc){
            ...
            case 1:case 2:case 3:case 4: case 5:case 6: case 7:case 8:case 9:case 10:case 11:case 12:
                ...
                for(int i=0;i<6;i++){
                    for(int j=0;j<7;j++){
                        if(calend[opc-1][i][j]!=0)
                            cout<<calend[opc-1][i][j]<<"\t";
                        else
                            cout<<"  "<<"\t";
                    }
                    cout<<endl;
            ...
            default:
                cout<<"Opcion invalida, intente otra vez"<<endl<<endl;
                system("pause");
                break;
        }
