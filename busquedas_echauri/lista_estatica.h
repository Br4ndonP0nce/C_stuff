#ifndef BUSQUEDAS_ECHAURI_LISTA_ESTATICA_H
#define BUSQUEDAS_ECHAURI_LISTA_ESTATICA_H
#include <iostream>
...
template<size_t n, typename T>
size_t ListaEstatica<n, T>::currentIndex() const
{
    return index;
}
...
{
    /*cout << "Notice: Trying [] on size_t position: " << position << endl;
    cout << "Notice: CurrentIndex is " << index << endl;
    cout << "Notice: position >= index equals: " << (position >= index) << endl; */
    if (empty())
...
#endif //BUSQUEDAS_ECHAURI_LISTA_ESTATICA_H
