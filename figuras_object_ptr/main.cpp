    ...
    do {
        ...
        switch (opc) {
            case '1':
                ...
                ptrc->calcArea();
                ptrc->setPerimetro();
                cout << "el area es " << ptrc->getArea() << endl;
                cout << "el perimetro es: " << ptrc->getPerimetro()<<endl;
                system("pause");
                system("cls");
                break;
            case '2':
                ...
                ptrr=&r;
                ptrr->setBase(base_);
                ptrr->setAltura(altura_);
                ptrr->calcArea();
                cout << "el area es: " << ptrr->getArea();
                ptrr->calcPeri();
                cout << "\nel perimetro es: " << ptrr->getPeri()<<endl;
                system("\npause");
                system("cls");
                break;
            case '3':
                ...
                ptrt=&t;
                ptrt->setBase(base_);
                ptrt->setAltura(altura_);
                ptrt->calArea();
                system("pause");
                system("cls");
                cout << "el area es: " << ptrt->getArea() << endl;
                ptrt->calPer();
                cout << "el perimetro es: " << ptrt->getPer() << endl;
                system("pause");
                system("cls");
                break;
            case '4':
                ...
                cin >> diametro_;
                ptrcir=&circle;
                ptrcir->setRadio(radio_);
                ptrcir->setDiametro(diametro_);
                ptrcir->calArea();
                system("pause");
                system("cls");
                cout << "el area es: " << ptrcir->getArea() << endl;
                ptrcir->calPeri();
                cout << "el perimetro es: " << ptrcir->setPeri() << endl;
                system("pause");
                system("cls");
                break;
            case '5':
                ...
                cin>>lado_;
                ptrpol=&poli;
                ptrpol->setLados(lados);
                ptrpol->setLado(lado_);
                ptrpol->setPeri();
                ptrpol->setArea();
                cout<<"el area es:"<<ptrpol->getArea()<<endl;
                cout<<"el perimetro es: "<<ptrpol->getPeri()<<endl;
                system("pause");
                system("cls");
                break;
            case '6':
